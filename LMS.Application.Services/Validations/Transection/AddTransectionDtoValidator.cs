...
public class AddTransectionDtoValidator : AbstractValidator<AddTransectionDto>
{
    public AddTransectionDtoValidator()
    {
        ...
        RuleFor(transaction => transaction.ReturnDate)
            ...
            .GreaterThanOrEqualTo(transaction => transaction.RenewDate.Value)
                ...
                .WithMessage("Return date must be less than or equal to Renew date when Renew date is provided.")
