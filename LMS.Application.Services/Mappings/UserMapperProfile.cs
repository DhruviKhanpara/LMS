...
public class UserMapperProfile : Profile
{
    public UserMapperProfile()
    {
        ...
        CreateMap<User, GetUserDto>()
            ...
            .ForMember(dest => dest.ProfilePhoto, src => src.MapFrom(act => !string.IsNullOrWhiteSpace(act.ProfilePhoto) ? FileService.ConvertToRelativePath(act.ProfilePhoto) : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSG2h3dtkFclxksGm2bXE8R53sUemVyVGmJTg&s"))
            ...
            .ForMember(dest => dest.HasOccupiedBook, src => src.MapFrom(act => act.Transections != null ? act.Transections.Any(x => x.IsActive && !new[] { (long)TransectionStatusEnum.Returned, (long)TransectionStatusEnum.Cancelled, (long)TransectionStatusEnum.ClaimedLost }.Contains(x.StatusId)) : false));
        ...
        CreateMap<User, GetUserDetailDto>()
            ...
            .ForMember(dest => dest.HasPenalty, src => src.MapFrom(act => act.Penalties != null ? act.Penalties.Any(x => x.IsActive && x.StatusId == (long)FineStatusEnum.UnPaid) : false))
            .ForMember(dest => dest.HasOccupiedBook, src => src.MapFrom(act => act.Transections != null ? act.Transections.Any(x => x.IsActive && !new[] { (long)TransectionStatusEnum.Returned, (long)TransectionStatusEnum.Cancelled, (long)TransectionStatusEnum.ClaimedLost }.Contains(x.StatusId)) : false))
            .ForMember(dest => dest.HasActiveReservation, src => src.MapFrom(act => act.Reservations != null ? act.Reservations.Any(x => x.IsActive && !new[] { (long)ReservationsStatusEnum.Fulfilled, (long)ReservationsStatusEnum.Cancelled }.Contains(x.StatusId)) : false))
        ...
        CreateMap<User, UserProfileDto>()
            ...
            .ForMember(dest => dest.OccupiedBookCount, src => src.MapFrom(act => act.Transections != null ? act.Transections.LongCount(x => x.IsActive && !new[] { (long)TransectionStatusEnum.Returned, (long)TransectionStatusEnum.Cancelled, (long)TransectionStatusEnum.ClaimedLost }.Contains(x.StatusId)) : 0))
            .ForMember(dest => dest.ActiveReservationCount, src => src.MapFrom(act => act.Reservations != null ? act.Reservations.LongCount(x => x.IsActive && !new[] { (long)ReservationsStatusEnum.Fulfilled, (long)ReservationsStatusEnum.Cancelled }.Contains(x.StatusId)) : 0))
        ...
        CreateMap<User, ProfilePhotoUpdateDto>()
            ...
            .ForMember(dest => dest.ProfilePhotoPath, src => src.MapFrom(act => !string.IsNullOrWhiteSpace(act.ProfilePhoto) ? FileService.ConvertToRelativePath(act.ProfilePhoto) : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSG2h3dtkFclxksGm2bXE8R53sUemVyVGmJTg&s"));
